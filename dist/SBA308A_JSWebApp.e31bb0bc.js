...
function _initialLoad() {
  _initialLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var option, response, jsonData, i, cardItem, cardDiv, img;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          for (i = 0; i < 5; i++) {
            cardItem = document.querySelector('#card_id');
...
//# sourceMappingURL=/SBA308A_JSWebApp.e31bb0bc.js.map